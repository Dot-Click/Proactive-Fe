                    ...
                    {showColumns && columnsMenuItems && columnsMenuItems.length > 0 && (
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="outline" className="bg-[#FAFAFA] text-black border border-[#EFEFEF] hover:bg-[#FAFAFA] cursor-pointer font-medium  md:w-30 w-auto  py-5 rounded-[15px]">
                                <Funnel fill="#000000" />
                                    Filter
                                </Button>
                            </DropdownMenuTrigger>
