...
// import Template from "@/assets/sidebaricon/template.avif";
  ...
  const onSubmit = async (data: TripFormType) => {
    ...
    try {
      ...
      const payload = {
        ...
        coordinatorInstagram: (data.CoordinatorInstagram && data.CoordinatorInstagram.startsWith('http')) ? data.CoordinatorInstagram : null,
        coordinatorLinkedin: (data.CoordinatorLinkedin && data.CoordinatorLinkedin.startsWith('http')) ? data.CoordinatorLinkedin : null,
        // dynamic sections
