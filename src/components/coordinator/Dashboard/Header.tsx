...
const Header = () => {
    return (
        <div className="bg-white px-6 py-6 rounded-[20px] mt-5">
            <div className="flex lg:flex-row flex-col gap-3 justify-between items-center">
                ...
                <div className="flex lg:flex-row flex-col gap-4 w-full lg:w-auto">
                    <Button className="bg-[#FAFAFA] w-full text-black font-medium border border-[#D4D4D4] hover:bg-[#ece7e7] cursor-pointer lg:w-30 py-5 rounded-full">
                        <Funnel fill="#000000" />
                        All Status
                    </Button>
                    <Button className="bg-[#000000] w-full text-white font-medium hover:bg-[#4b4949] cursor-pointer lg:w-42 py-5 rounded-full">
                        <Plus fill="#000000" />
                         Create New Trip
                    </Button>
                </div>
