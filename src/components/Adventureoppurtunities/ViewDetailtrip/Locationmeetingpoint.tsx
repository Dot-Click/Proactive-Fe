...
const Locationmeetingpoint = ({ trip }: { trip: any }) => {
    ...
    return (
        <div className="py-12 border-b border-[#ECECF1]">
            <h3 className="text-[#221E33] font-bold text-2xl mb-8 font-sans">Trip Essentials</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-[#C4FFF0] border border-[#156250] rounded-2xl py-5 px-6 flex items-center gap-4 group hover:shadow-md transition-all">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[#156250] text-sm font-medium font-sans">Group size</span>
                        <span className="text-[#221E33] font-bold text-base font-sans leading-tight">
                ...
                <div className="bg-[#C4FFF0] border border-[#156250] rounded-2xl py-5 px-6 flex items-center gap-4 group hover:shadow-md transition-all">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[#156250] text-sm font-medium font-sans">Rhythm</span>
                        <span className="text-[#221E33] font-bold text-base font-sans leading-tight">
                            {data?.rhythm || "Dynamic"}
                        </span>
                    </div>
                ...
                <div className="bg-[#C4FFF0] border border-[#156250] rounded-2xl py-5 px-6 flex items-center gap-4 group hover:shadow-md transition-all">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[#156250] text-sm font-medium font-sans">Sport level</span>
                        <span className="text-[#221E33] font-bold text-base font-sans leading-tight">
                ...
                <div className="bg-[#C4FFF0] border border-[#156250] rounded-2xl py-5 px-6 flex items-center gap-4 group hover:shadow-md transition-all">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[#156250] text-sm font-medium font-sans">Duration</span>
                        <span className="text-[#221E33] font-bold text-base font-sans leading-tight">
