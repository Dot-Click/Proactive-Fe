...
const BasicInfo = () => {
  ...
  // Custom Dropdown State (removed - using text input now)
  ...
  // Location dropdown removed - text input is used now
  useEffect(() => {
    // No longer needed with free-text location input
  }, []);
      ...
      <div className="bg-white px-6 py-6">
        ...
        <div className="mt-10">
          <div className="grid md:grid-cols-2 gap-4 pb-6">
            ...
            {/* LOCATION TEXT INPUT - Open text for custom locations */}
            <Controller
              control={control}
              name="location"
              render={({ field }) => (
                <FormItem className="mt-6">
                  ...
                  <FormControl>
                    <Input
                      ...
                      className="bg-[#FAFAFE] border border-[#EFEFEF] focus:border-[#0DAC87] h-12 rounded-md px-4"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
