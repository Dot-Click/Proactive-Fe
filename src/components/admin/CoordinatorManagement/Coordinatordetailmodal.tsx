        ...
        <div>
            <DialogContent className="sm:max-w-[880px] max-h-[90vh] border-[6px] border-[#E3E3E3] rounded-[20px] overflow-y-auto">
                ...
                <div className="grid gap-4">
                    ...
                    <div className="flex md:items-center justify-between gap-3 bg-[#FAFAFE] md:px-6 px-4 py-6 rounded-[16px] mt-5">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="flex flex-col justify-between">
                                ...
                                <div className="flex md:flex-row flex-col gap-6 mt-4 text-[13px] text-[#221E33]">
                        ...
                        <div className="border border-[#E0E1E2] rounded-[10px]">
                            ...
                            <div className="px-5 py-4 flex flex-col gap-4">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="text-[#666373] grid grid-cols-2 gap-y-2">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="text-[#666373] grid grid-cols-3 gap-y-2">
