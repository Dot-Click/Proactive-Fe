...
//                                                 <SelectTrigger className="w-full bg-[#FAFAFE] border border-[#EFEFEF] px-4 py-6">
//                                                     <SelectValue>
//                                                         {field.value ? getDisplayValue(field.value, certificateOptions) : "Select Certificate"}
//                                                     </SelectValue>
//                                                 </SelectTrigger>
//                                             </FormControl>
//                                             <SelectContent>
...
//                                                 <SelectTrigger className="w-full bg-[#FAFAFE] border border-[#EFEFEF] px-4 py-6">
//                                                     <SelectValue>
//                                                         {field.value ? getDisplayValue(field.value, coordinatorOptions) : "Select Type"}
//                                                     </SelectValue>
//                                                 </SelectTrigger>
//                                             </FormControl>
//                                             <SelectContent>
...
//                                                 <SelectTrigger className="w-full bg-[#FAFAFE] border border-[#EFEFEF] px-4 py-6">
//                                                     <SelectValue>
//                                                         {field.value ? getDisplayValue(field.value, levelOptions) : "Set Permissions"}
//                                                     </SelectValue>
//                                                 </SelectTrigger>
//                                             </FormControl>
//                                             <SelectContent>
