...
// import { Check } from "lucide-react";
// import { useGetCoordinator } from "@/hooks/getcoordinatorforedithook"; // Added hook
...
//             {/* Debug info banner */}
//             <div className="bg-blue-50 border-l-4 border-blue-500 p-3 mb-4 mt-4">
//                 <p className="text-blue-700 text-sm">
//                     <strong>Debug Info:</strong> Check browser console (F12) for API response data. 
//                     ID: <span className="font-mono bg-blue-100 px-2 py-1 rounded">{id}</span>
//                 </p>
//             </div>
...
//             console.log("Certificate Level:", coordinator.certificateLvl);
//             console.log("Coordinator Type:", coordinator.type);
//             console.log("Access Level:", coordinator.accessLvl);
...
//     // Helper function to get display label for select values
...
//                     <br />ID: <span className="font-mono bg-blue-100 px-2 py-1 rounded">{id}</span>
//                     {apiResponse?.coordinator && (
//                         <>
//                             <br /><span className="text-green-600">✓ Data loaded successfully</span>
//                             <br />Certificate: <span className="font-mono bg-green-100 px-2 py-1 rounded">{formValues.certificate || "Not set"}</span>
//                             <br />Type: <span className="font-mono bg-green-100 px-2 py-1 rounded">{formValues.coordinator || "Not set"}</span>
//                             <br />Level: <span className="font-mono bg-green-100 px-2 py-1 rounded">{formValues.level || "Not set"}</span>
//                         </>
//                     )}
//                 </p>
//             </div>
...
//                             <Button
//                                 type="submit"
//                                 className="rounded-full px-8 py-6 font-medium cursor-pointer bg-[#0DAC87] hover:bg-[#0C9A7A]"
//                             >
//                                 Update Coordinatorsd
//                             </Button>
//                         </div>
//                     </div>
//                 </form>
...
//             // Prepare form data - SIMPLE DIRECT MAPPING
//             const formData = {
//                 username: coordinator.fullName || "",
//                 email: coordinator.email || "",
//                 phone: coordinator.phoneNumber || "",
...
//       </FormLabel>
//       <FormControl>
//         {/* Relative wrapper to position the chevron */}
//         <div className="relative">
//           <select
//             {...field}
...
//       </FormLabel>
//       <FormControl>
//         {/* Relative wrapper for custom chevron positioning */}
//         <div className="relative">
//           <select
//             {...field}
//             className="w-full bg-[#FAFAFE] border border-[#EFEFEF] px-4 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 appearance-none cursor-pointer text-[#242E2F]"
...
const onSubmit = (values: z.infer<typeof formSchema>) => {
 ...
 // Create FormData object
        ...
        // Add ALL fields EXACTLY as shown in Swagger documentation
        // 1. String fields
        formData.append("fullName", values.username.trim());
        formData.append("phoneNumber", values.phone.replace(/\D/g, '')); // Remove all non-digits
        formData.append("bio", values.Bio.trim());
        formData.append("certificateLvl", values.certificate);
        formData.append("yearsOfExperience", values.experience.toString());
        formData.append("location", values.location.trim());
        formData.append("type", values.coordinator);
        formData.append("accessLvl", values.level);

        // 2. Arrays - Send each item as separate entry
        // IMPORTANT: Use EXACT field names from Swagger: "specialities" and "languages"
        values.Specialties.forEach((item) => {
        ...
        // 4. Password (optional - only if provided)
        ...
        console.log("=== FINAL FORM DATA TO SEND (Swagger Format) ===");
