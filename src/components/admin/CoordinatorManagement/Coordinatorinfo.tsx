                    ...
                    {displayLoading ? (
                        ...
                        displayData.map((user: Coordinator) => (
                            ...
                            >
                                    ...
                                    <div className="flex flex-col lg:flex-row gap-3 items-center">
                                        ...
                                        <div className="flex flex-col items-center lg:items-start justify-center">
                                            ...
                                            <span className="flex flex-wrap items-center gap-1 text-[#666373] text-[14px]">
                                                <Star fill="#FDBF08" color="#FDBF08" size={16} />
                                                <span className="text-[#D9D9D9]">•</span>
                                                {typeof user.totalTrips !== 'undefined' ? `trips led ${user.totalTrips}` : 'trips led 0'}
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-3 gap-3 mt-6">
                                    <div className="bg-[#FAFAFE] flex flex-col items-center justify-center py-3 rounded-[12px]">
                                        <span className="font-semibold text-[15px]">{user.totalTrips ?? 0}</span>
                                        <span className="text-[#666373] text-[12px] text-nowrap">Total Trips</span>
                                    </div>
                                    <div className="bg-[#FAFAFE] flex flex-col items-center justify-center py-3 rounded-[12px]">
                                        <span className="font-semibold text-[15px]">{user.totalRevenue ? `€${user.totalRevenue}` : '€0'}</span>
                                        <span className="text-[#666373] text-[12px] text-nowrap">Revenue</span>
                                    </div>
                                    <div className="bg-[#FAFAFE] flex flex-col items-center justify-center py-3 rounded-[12px]">
                                        <span className="font-semibold text-[15px]">{user.repeatCustomers ?? 0}</span>
                                        <span className="text-[#666373] text-[12px] text-nowrap">Repeat Customers</span>
                                    </div>
                                </div>
