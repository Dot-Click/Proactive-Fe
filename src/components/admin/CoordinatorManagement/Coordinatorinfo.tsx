...
const Coordinatorinfo = () => {
    return (
        <div>
            ...
            {/* <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-2 mt-3">
                {
                    CoordinatorData.map((user, i) => (
                        <div key={i} className="bg-white border border-[#E0E1E2] px-4 py-6 rounded-[20px] ">
                            ...
                            <div className="grid md:grid-cols-3 gap-4 mt-6">
                                <div className="bg-[#FAFAFE] flex flex-col items-center py-3 px-3 rounded-[12px]">
                                    ...
                                    <span className="text-[#666373] md:text-[10px] text-nowrap">Active Trips</span>
                                </div>
                                <div className="bg-[#FAFAFE] flex flex-col items-center py-3 rounded-[12px]">
                                    <span className="font-semibold">{user.revenue}</span>
                                    <span className="text-[#666373] md:text-[10px] text-nowrap">Revenue</span>
                                </div>
                                <div className="bg-[#FAFAFE] flex flex-col items-center py-3 rounded-[12px]">
                                    <span className="font-semibold">{user.repeatCustomer}</span>
                                    <span className="text-[#666373] md:text-[10px] text-nowrap">Repeat Customers</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 flex lg:flex-row flex-col gap-2">
                                <div className="">
                                    <Dialog>
                                        <DialogTrigger asChild>
                                            <Button className="rounded-full h-12 px-12 font-semibold cursor-pointer">
                                                View Detail
                                            </Button>
                                        </DialogTrigger>
                                ...
                                <Button
                                    variant="outline"
                                    className="rounded-full h-12 px-12 border border-[#9C0000] text-[#9C0000] font-semibold cursor-pointer hover:text-[#9C0000]"
                                >
                                    Block
                                </Button>
                            </div>
