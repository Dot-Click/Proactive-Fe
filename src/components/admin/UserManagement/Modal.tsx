                    ...
                    <div className="grid md:grid-cols-4 grid-cols-1 gap-4 ">
                        {
                            userData.map((user, i) => (
                                <div key={i} className="flex flex-col items-center rounded-[12px] px-5 py-6 bg-[#FAFAFE] hover:shadow-sm transition-all duration-300">
                                    <span className="cursor-pointer font-bold text-[30px] bg-linear-to-r from-[#221E33] to-[#565070]  text-transparent bg-clip-text">{user.Number}</span>
                        ...
                        <div className="border border-[#E0E1E2] rounded-[10px]">
                            ...
                            <div className="px-5 py-4 flex flex-col gap-6">
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="bg-[#F5F5F5] px-6 py-2 rounded-xl">
