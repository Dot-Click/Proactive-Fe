...
const Tripcategories = () => {
  return (
    <div className="flex-1 px-5 py-5 rounded-[25px] bg-white mt-2 shadow-sm min-w-[280px] h-full">
      <h1 className="font-medium">Trip Categories</h1>
      <div className="flex justify-center items-center mt-5">
        <img src={tripStats} alt="tripStats" className="h-40" />
      </div>
      <div className="mt-4 flex gap-3 flex-nowrap mb-1">
