            ...
            <div className="flex flex-col gap-3 px-4 py-6 overflow-y-scroll h-152">
                {
                    upcomingtrip?.map((trip: any, index: number) => {
                        return (
                            <div key={index} className="bg-[#FFFFFF] px-4 py-6 rounded-[20px] shadow-md">
                                <div className="flex lg:flex-row flex-col gap-4">
                                    <img src={trip?.coverImage || trip1} alt="trip1" className="h-50 w-50 rounded-lg " />
                                        ...
                                        <div className="flex lg:flex-row flex-col w-full justify-between gap-4">
                                            <div className="flex flex-col gap-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[#666373] text-[14px]">{new Date(trip?.startDate).toDateString()} - {new Date(trip?.endDate).toDateString()}</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <img src={time} alt="time" className="h-4" />
                                                    <span className="text-[#666373] text-[14px]">In {getDaysLeft(trip?.startDate)} days</span>
                                                </div>
                                            </div>
                                            <div className="flex flex-col gap-1 ">
                                                <div onClick={() => navigate(`/user-dashboard/viewdetail/${trip.id}`)} className="flex justify-center items-center gap-2 rounded-full cursor-pointer bg-[#0DAC87] hover:bg-[#10a17f] px-4 py-4 text-[#FFFFFF] font-semibold">
                                                    View Detail
