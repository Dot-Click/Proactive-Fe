...
const JoinProactive = () => {
    return (
        <div className="">
            <div className="flex flex-col lg:gap-12 gap-2 justify-center items-center relative lg:py-20 py-20">
                ...
                <img
                    src={box1}
                    alt="box1"
                    className="w-26 h-26 absolute left-105 top-10 opacity-80 lg:flex hidden"
                />
