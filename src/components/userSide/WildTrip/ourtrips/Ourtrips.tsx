  ...
  return (
    <div className="bg-linear-to-r from-[#F0F5FD]/18 to-[#F0F5FD]">
      ...
      <div className="flex flex-col lg:gap-8 gap-4 lg:pt-20 pt-10">
        <h1 className="text-center lg:text-4xl text-2xl font-bold bg-linear-to-r from-[#221E33] to-[#565070] text-transparent bg-clip-text">{t('wildTrip.ourTrips.title')}</h1>
      </div>
