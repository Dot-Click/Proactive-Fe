    ...
    return (
        <div className="relative bg-[#F0F5FD]/28">
            ...
            <div className="flex flex-col lg:gap-6 absolute inset-0 lg:top-8 top-2 lg:py-8">
                <h1 className="text-center lg:text-5xl bg-linear-to-r from-[#F7ECBE] to-[#F7ECBE]/96  text-transparent bg-clip-text font-extrabold">Our Values</h1>
                <p className="text-[8px] lg:text-lg font-semibold text-[#FFFFFF] text-center">The principles that guide everything we do</p>
            </div>
