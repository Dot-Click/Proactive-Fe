...
const ImpactNumber = () => {
    ...
    return (
        <div className="relative mb-5">
            ...
            <div className="flex flex-col lg:gap-6 absolute inset-0 lg:top-8 top-2 lg:py-8">
                <h1 className="text-center lg:text-5xl bg-linear-to-r from-[#F7ECBE] to-[#F7ECBE]/96  text-transparent bg-clip-text font-extrabold">{t('home.impactNumbers')}</h1>
                <p className="text-[8px] lg:text-lg font-semibold text-[#FFFFFF] text-center" dangerouslySetInnerHTML={{ __html: t('home.adventureOpportunitiesSubtitle').replace(/\n/g, '<br className="lg:block hidden" />') }} />
            </div>
            <div className="flex flex-col gap-6 absolute inset-0 justify-center items-center lg:top-20 top-10">
                <ImpactCard/>
            </div>
