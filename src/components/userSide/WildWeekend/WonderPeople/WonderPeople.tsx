    ...
    return (
        <>
            <div className="relative">
                <img src={WonderPeoplebg} alt="WonderPeoplebg" className="lg:h-screen w-full" />
                <div className="bg-black absolute inset-0 opacity-60 lg:h-screen" />
                <div className="flex flex-col justify-center items-center lg:gap-12 gap-6 absolute inset-0 lg:mt-12 px-4">
                    ...
                    <img src={WonderPeopleVideo} alt="WonderPeopleVideo" className="lg:w-220" />
                </div>
