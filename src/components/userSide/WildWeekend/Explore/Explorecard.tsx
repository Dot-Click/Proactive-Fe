    ...
    <div className="flex flex-col gap-4 px-4">
      ...
      <div className="relative w-full max-w-[960px] mx-auto">
        ...
        <div className="absolute lg:bottom-6 bottom-2 left-4 right-4 flex lg:flex-row flex-col justify-between items-center z-10">
          ...
          <Button className="bg-[#0DAC87] hover:bg-[#0f9e7d] cursor-pointer text-white rounded-full lg:px-8 lg:py-5 lg:mt-0 mt-4">More Info</Button>
        </div>

      </div>

      <div className="relative w-full max-w-[960px] mx-auto">
        <img src={Explore2} alt="Explore2" className="w-full lg:h-auto h-100 block rounded-lg object-cover" />
