        ...
        <div className="relative w-full">
            ...
            <div className="flex flex-col justify-center gap-2 absolute inset-0 px-4">
                <h1 className="text-center bg-linear-to-r from-[#F7ECBE] to-[#F7ECBE] lg:text-4xl md:text-3xl sm:text-2xl text-transparent bg-clip-text font-bold">
                    {t('wildWeekend.openOpportunities.title')}
                </h1>
                <p className="text-center text-[#FFFFFF] text-sm md:text-base lg:text-lg" dangerouslySetInnerHTML={{ __html: t('wildWeekend.openOpportunities.subtitle').replace(/\n/g, '<br />') }} />
                <div className="flex flex-col sm:flex-row justify-center mt-8 gap-4 sm:gap-6">
                    <Button onClick={() => navigate('/open-oppurtunities')} className="hover:scale-105 transition-all duration-300 bg-[#FFFFFF] hover:bg-[#f7f1f1] cursor-pointer text-[#03664F] font-semibold rounded-full px-6 py-5">
                        {t('wildWeekend.openOpportunities.startJourney')}
                    </Button>
                    <Button onClick={() => navigate('/contact')} variant={'ghost'} className="hover:scale-105 transition-all duration-300 hover:bg-[#f7f1f1] text-[#FFFFFF] cursor-pointer border border-[#FFFFFF] rounded-full px-6 py-5">
                        {t('wildWeekend.openOpportunities.contactUs')}
                    </Button>
                </div>
            </div>
        </div>
...
export default OpenOppurtunities